import {
  InstallationActions, FETCH_INSTALLATION_STATUS, FETCH_INSTALLATION_STATUS_SUCCESS, FETCH_INSTALLATION_STATUS_FAILURE,
...
const installationReducer = (state = initialState, action: InstallationActions): InstallationState => {
  switch (action.type) {
